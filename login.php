...
<body>
    <div class="main-login">
        <div class="left-login">
            ...
            <img src="img/img_login.svg" class="img_login" alt="login animaçao">
        </div>
            ...
            <div class="card-login">
                ...
                <form action="login.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="btn2">
                        ...
                        <a href="cadastro.php" class="btn-cadastrar" name="btn_cadastrar"
                            style="color: #ffff; text-decoration: none">Cadastrar</a>
                    </div>
                </form>
            </div>
        </div>
